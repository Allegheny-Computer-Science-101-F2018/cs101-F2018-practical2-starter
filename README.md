...
# cs101-F2018-practical2-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Practical 2 in Computer Science 101.
...
- practicalone/StatisticsCalculator.java:
  ...
  - Produces output that contains exactly two of the fragment `Displaying`
  - Produces output that contains exactly one of the fragment `6.78`
  - Produces output that contains exactly one of the fragment `23.04`
  - Produces output that contains exactly one of the fragment `4.80`
  - Passes all of the test cases defined in the `TestStatisticsCalculator.java` file.
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2018/cs101-F2018-practical2-starter.git
```
...
you can go to the [Computer Science 101 Practical 2
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-practical2-starter)
